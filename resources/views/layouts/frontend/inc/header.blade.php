<header>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="top-left pull-left">
            ...
            <div class="wel-come-msg"> Welcome to the largest online store! </div>
          </div>
  ...
  <div class="container">
    <div class="header-inner">
      <div class="col-sm-4 col-xs-4 header-left">
        <div id="logo"> <a href="index.html"><img src="{{ asset('assets/frontend/image/logo.png') }}" title="E-Commerce" alt="E-Commerce" class="img-responsive" /></a> </div>
      </div>
